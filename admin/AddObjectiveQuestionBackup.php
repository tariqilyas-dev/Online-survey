<?php
 ...
 if (isset($post["submit"]))
  ...
  echo "<script>window.location.href = 'AddQuestion.php'</script>";
  return false;
  }
  ...
  <div class="input-form">
    ...
    <br/>
      ...
      <label>Question :</label>
       <textarea name="question" id="question" class="form-control" rows="12"></textarea>
      ...
      <input type="text" class="form-control" name="tooltipopt1"/>
      ...
      <input type="text" class="form-control" name="tooltipopt2"/>
      ...
      <input type="text" class="form-control" name="tooltipopt3"/>
      ...
      <input type="text" class="form-control" name="tooltipopt4"/>

                  <br/>
      <label>True option</label>
      <input type="text" class="form-control" name="trueans"/>
